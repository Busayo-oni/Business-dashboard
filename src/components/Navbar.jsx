...
import { ChartNoAxesColumn, ShoppingCart, ShoppingBag, ChartLine, MessageSquareMore, Settings, LogOut } from 'lucide-react'
      ...
      >
        <nav className="p-4">
          ...
          <ul className="text-left ml-6 mt-10">
            <li className="">
              <a href="#" className="block p-2 hover:bg-gray-700 rounded-md"><ChartNoAxesColumn className="inline-block mr-5"/>
                Leaderboard
              </a>
            </li>
            <li>
        ...
        <div className="w-[238px] h-[261px] px-12 mx-auto my-10 relative overflow-hidden  rounded-3xl bg-[#5D5FEF]">
          ...
          <div className="text-center py-10">
            ...
            <p className="text-[#fff] text-sm mt-2">Get access to all features on tetumbas</p>
            <button className="bg-white text-[#5D5FEF] font-semibold text-[16px] w-[126px] h-[46px] rounded-lg mt-5 ">Get Pro</button>
          </div>
